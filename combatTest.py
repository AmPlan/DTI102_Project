...
def init(screen, clock):
    global choices, questionLabel, game_over, GAME_STATE, level, restart_button_rect, time_start
    # Set up
    running = True
    ...
    def mouseInput():
        global level, game_over, time_start, restart_button_rect, GAME_STATE, coin_mini_game_result, player_data
