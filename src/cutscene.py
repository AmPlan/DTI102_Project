...
def init(screen, clock):
    screen = pygame.display.set_mode((1530, 850), playerData.screenMode)
    ...
    dialogue_box = pygame.Surface((1050, 120), pygame.SRCALPHA) # Make the background of surface alpha
